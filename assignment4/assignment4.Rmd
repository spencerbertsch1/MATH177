...
# Should this be decreasing FALSE or decreasing TRUE? I think we want the best fits, so we would want to smallest p-values, so we should use decreasing = FALSE

```{r}
top_p_value_df <- df1[order(df1$prevave, decreasing=FALSE), ]
top_p_value_df
```
# RECALCULATE THIS SECTION!!! 
